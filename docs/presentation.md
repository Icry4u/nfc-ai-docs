...
<figure markdown>
  ![Splash Screen](assets/screenshots/01_splash.png){ width="300" }
...
<figure markdown>
  ![Welcome Screen](assets/screenshots/02_welcome.png){ width="300" }
  <figcaption>Welcome screen — language selection</figcaption>
</figure>

<figure markdown>
  ![Welcome Filled](assets/screenshots/03_welcome_filled.png){ width="300" }
...
<figure markdown>
  ![Tutorial Step 1](assets/screenshots/04_home_tutorial.png){ width="300" }
  <figcaption>Spotlight tutorial — NFC scan area</figcaption>
</figure>

<figure markdown>
  ![Tutorial Step 2](assets/screenshots/05_tutorial_2.png){ width="300" }
...
<figure markdown>
  ![Simulate Dialog](assets/screenshots/06_simulate_dialog.png){ width="300" }
  <figcaption>NFC scan simulation (for demo purposes)</figcaption>
</figure>

<figure markdown>
  ![Product Detail](assets/screenshots/07_product_detail.png){ width="300" }
...
<figure markdown>
  ![AI Recommendations](assets/screenshots/08_ai_recommendations.png){ width="300" }
  <figcaption>AI recommendations with safety verification</figcaption>
</figure>

<figure markdown>
  ![Recommendation Detail](assets/screenshots/09_recommendation_detail.png){ width="300" }
...
<figure markdown>
  ![History Tutorial](assets/screenshots/10_history_tutorial.png){ width="300" }
  <figcaption>History screen tutorial</figcaption>
</figure>

<figure markdown>
  ![History](assets/screenshots/11_history.png){ width="300" }
...
<figure markdown>
  ![Settings Top](assets/screenshots/12_settings_top.png){ width="300" }
  <figcaption>Settings — profile & dietary preferences</figcaption>
</figure>

<figure markdown>
  ![Settings Bottom](assets/screenshots/13_settings_bottom.png){ width="300" }
...
<figure markdown>
  ![About](assets/screenshots/14_about.png){ width="300" }
  <figcaption>About screen — app version & team info</figcaption>
</figure>

<figure markdown>
  ![Home with Scans](assets/screenshots/15_home_with_scans.png){ width="300" }
